...
// All useful implementations are subpackages of this package, e.g. github.com/x-clone/go-diskfs/gpt
package partition

import (
	"fmt"

	"github.com/x-clone/go-diskfs/partition/gpt"
	"github.com/x-clone/go-diskfs/partition/mbr"
