...
//
// gpt.Table implements the Table interface in github.com/x-clone/go-diskfs/partition
//
// Normally, the best way to interact with a disk is to use the github.com/x-clone/go-diskfs package,
